...
class NeedleReachMem(PsmEnvMem):
    """
    ...
    def _env_setup(self):
        super(NeedleReachMem, self)._env_setup()
    ...
    def _set_action(self, action: np.ndarray):
        ...
        super(NeedleReachMem, self)._set_action(action)
...
if __name__ == "__main__":
    env = NeedleReachMem(render_mode='human')  # create one process and corresponding env
