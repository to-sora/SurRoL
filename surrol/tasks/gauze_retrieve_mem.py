...
from surrol.tasks.psm_env_mem import PsmEnvMem
...
class GauzeRetrieveMem(PsmEnvMem):
    """
    ...
    def _env_setup(self):
        super(GauzeRetrieveMem, self)._env_setup()
    ...
    def _set_action(self, action: np.ndarray):
        ...
        super(GauzeRetrieveMem, self)._set_action(action)
...
if __name__ == "__main__":
    env = GauzeRetrieveMem(render_mode='human')  # create one process and corresponding env
