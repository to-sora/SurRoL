...
from surrol.tasks.psm_env_mem import PsmsEnvMem
...
class BiPegTransferMem(PsmsEnvMem):
    ...
    def _env_setup(self):
        super(BiPegTransferMem, self)._env_setup()
    ...
    #     super(BiPegTransferMem, self)._set_action(action)
...
if __name__ == "__main__":
    env = BiPegTransferMem(render_mode='human')  # create one process and corresponding env
