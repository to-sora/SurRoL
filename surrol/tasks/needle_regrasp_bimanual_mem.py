...
class NeedleRegraspMem(PsmsEnvMem):
    ACTION_MODE = 'pitch'
    ...
    def _env_setup(self):
        super(NeedleRegraspMem, self)._env_setup()
...
if __name__ == "__main__":
    env = NeedleRegraspMem(render_mode='human')  # create one process and corresponding env
